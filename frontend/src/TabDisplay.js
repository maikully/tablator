      ...
      <OverlayTrigger
        ...
        overlay={
          <Popover>
            ...
            <Popover.Body>
              The difficulty of a tab is calculated using the total cost of the
              fingering sequence, scaled by the number of notes. A higher difficulty means the
              tab's fingerings are more awkward to play.
            </Popover.Body>
          </Popover>
        }
      >
